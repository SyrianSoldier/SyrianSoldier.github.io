import{o,c as r,e as t,w as u,j as d,t as m,a as h,p as c,m as f,b as w,f as N}from"./app-f65858bf.js";import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";const v={data(){return{moduleName:"",baseUrl:"",tsDefinition:"",apiCode:"",isPreviewVisible:!1}},methods:{generateCode(){this.generateTsDefinition(),this.generateApiCode()},generateTsDefinition(){const e=this.capitalize(this.moduleName);this.tsDefinition=`declare global {
  namespace API {
    namespace ${e} {
