import{o as i,c as l,e as n,w as u,j as d,t as p,a as c,p as h,m as w,b as P,f}from"./app-af135bce.js";import{_}from"./plugin-vue_export-helper-c27b6911.js";const v={data(){return{moduleName:"",baseUrl:"",tsDefinition:"",apiCode:"",isPreviewVisible:!1}},methods:{generateCode(){this.generateTsDefinition(),this.generateApiCode()},generateTsDefinition(){const t=this.moduleName.toLowerCase();this.tsDefinition=`type GenAPI<
  T extends {
    data: any;
    params: any;
    result: any;
