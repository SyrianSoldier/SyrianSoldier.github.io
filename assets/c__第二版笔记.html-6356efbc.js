...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="5"><li><strong>菱形继承与虚继承:</strong></li></ol><p><strong>菱形继承</strong>: 下图的菱形继承, 菱形继承的问题是假如动物的某成员, 被马和驴同时继承, 那么该属性被传递到骡子时, 骡子无法区分这个成员是从马继承过来的还是驴继承过来的.</p>`,26),q=n("p",null,[n("strong",null,"虚继承"),s(": 在菱形继承中, 位于中间层的类若为虚继承的类, 他们的通过继承获得的同名属性将只有一份被子类继承")],-1),x=a(`<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;iostream&gt;</span></span>
<span class="token keyword">using</span> <span class="token keyword">namespace</span> std<span class="token punctuation">;</span>
